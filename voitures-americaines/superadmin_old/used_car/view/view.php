	...
	?>
        ...
        if($fetch->publish==1){?>
                ...
                <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="inner_table">
                    <tr>
                      <td align="left" valign="top"><a href="<?= DEFAULT_ADMIN_URL;?>/used_car/update.php?car_id=<?= $fetch->id;?>"><img src="<?= ADMIN_IMAGE_URL;?>/edit.gif" width="16" height="16" alt="Edit This Block"  border="0" title="Edit This Block"/></a></td>
