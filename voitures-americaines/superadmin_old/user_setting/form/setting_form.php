...
<div id="content" >
   ...
   <div style="width:78%; float:left;">
	...
	<tr>
		...
		<td width="114" align="left" valign="top">First Name<font color="#FF0000">*</font>:</td>

		<td width="362" align="left" valign="top"><input name="fname" id="fname" type="text" class="text_box1" value="<?= $fname ;?>" /></td>
        ...
        <fieldset id="personal">
          ...
          <?= $errorMsg2;?>
			...
			<tr>
					...
					<td width="114" align="left" valign="top">Username<font color="#FF0000">*</font>:</td>

					<td width="362" align="left" valign="top"><input name="username" id="username" type="text"  value="<?= $username;?>"  class="text_box1" /></td>

				</tr>

				<tr>

					<td width="114" align="left" valign="top">Old Password<font color="#FF0000">*</font>:</td>

					<td width="362" align="left" valign="top"><input name="old_password" id="old_password" type="password" <?php if(isset($submit2)){?> value="<?= $old_password;?>" <?php } ?> class="text_box1" />
