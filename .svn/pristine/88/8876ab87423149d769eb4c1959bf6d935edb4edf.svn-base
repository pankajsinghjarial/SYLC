...
<?php else : ?>
		<?php /*?><div class="wpsc_categorisation_group" id="categorisation_group_<?php echo $category_id; ?>"><?php */?>
 
			<ul class="wpsc_categories wpsc_top_level_categories" id="categorisation_group_<?php echo $category_id; ?>">
				<li class="wpsc_category_<?php echo $curr_cat['term_id']; wpsc_print_category_classes($curr_cat);  ?>">
					...
					<a <?php if($curr_cat['name']) echo 'class:selected'; ?> href="<?php echo esc_url( $link ); ?>"><?php echo esc_html( $curr_cat['name'] ); ?></a>

					<?php /*?><ul class="wpsc_categories wpsc_second_level_categories">
			...
			<?php /*?><div class="clear_category_group"></div>
		</div><?php */?>
