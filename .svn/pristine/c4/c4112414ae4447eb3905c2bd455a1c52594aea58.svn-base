  ...
  <div id="content_main" class="clearfix">
    <div style="width:78%; float:left;">
      <div id="dashboard">
        <table width="100%">
          <tr>
            <td valign="top" style="padding:0 0 6px 0;"><div style="float:left; padding:5px 0 0 0;" class="page_head"><span>New Car Manager</span></div>
              <div style="float:right;"><a href="<?= DEFAULT_ADMIN_URL;?>/new_car/add.php"><img src="<?php echo ADMIN_IMAGE_URL; ?>/plus.jpg" align="absmiddle" title="Add New"/></a></div></td>
          </tr>
        </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #CCCCCC" class="display" id="example">
            <thead>
              <tr>
                ...
                <th width="209" align="center" valign="top" scope="col"> Brand</th>
	...
	?>
              <tr>
                ...
                <td align="center" valign="top"><?php
					$brand_name = mysql_fetch_row(mysql_query("SELECT title FROM brands WHERE id=$fetch->brand_id"));
					echo $brand_name[0];?></td>
                <td align="center" valign="top"><?php
        if($fetch->publish==1){?>
                ...
                <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="inner_table">
                    <tr>
                      <td align="left" valign="top"><a href="<?= DEFAULT_ADMIN_URL;?>/new_car/update.php?car_id=<?= $fetch->id;?>"><img src="<?= ADMIN_IMAGE_URL;?>/edit.gif" width="16" height="16" alt="Edit This Block"  border="0" title="Edit This Block"/></a></td>
