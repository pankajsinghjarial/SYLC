...
function twentyeleven_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Google Map', 'twentyeleven' ),
		'id' => 'sidebar-2',
	...
	register_sidebar( array(
		'name' => __( 'Voitures En Transit', 'twentyeleven' ),
		'id' => 'sidebar-4',
		'description' => __( 'An optional widget area for your site footer', 'twentyeleven' ),
		'before_widget' => '',
		'after_widget' => "",
	...
	register_sidebar( array(
		'name' => __( 'Les Affaires Ddu Moment', 'twentyeleven' ),
		'id' => 'sidebar-5',
		'description' => __( 'An optional widget area for your site footer', 'twentyeleven' ),
		'before_widget' => '',
		'after_widget' => "",
	...
	register_sidebar( array(
		'name' => __( 'Recent Post', 'twentyeleven' ),
		'id' => 'sidebar-6',
		'description' => __( 'An optional widget area for your site footer', 'twentyeleven' ),
		'before_widget' => '',
		'after_widget' => "",
	...
	register_sidebar( array(
		'name' => __( 'Categories', 'twentyeleven' ),
		'id' => 'sidebar-7',
		'description' => __( 'An optional widget area for your site footer', 'twentyeleven' ),
		'before_widget' => '',
		'after_widget' => " </div>",
		'before_title' => '<div class="blog_title">',
		'after_title' => '</div>
        <div class="recentpost_outer">',
	) );
	
		register_sidebar( array(
		'name' => __( 'Tags', 'twentyeleven' ),
		'id' => 'sidebar-8',
		'description' => __( 'An optional widget area for your site footer', 'twentyeleven' ),
		'before_widget' => '',
		'after_widget' => "</div>
		...
		'after_title' => '</div>
          <div class="recentpost_outer">
          <div class="blog_search_month">',
	) );
	
	
	register_sidebar( array(
		'name' => __( 'Search', 'twentyeleven' ),
		'id' => 'sidebar-10',
		'description' => __( 'An optional widget area for your site footer', 'twentyeleven' ),
		'before_widget' => '',
		'after_widget' => "",
...
function wpcf7_send_to_icontact($cfdata) {
	...
	$contact_fname = $formdata['contact'];
	$contact_phone = $formdata['telephone'];
	$contact_name = $formdata['name'];
	$contact_lastname = $formdata['prnom'];
	$contact_notes = $formdata['notes'];
	$contact_comment = $formdata['commentaires'];
	$contact_aircargode = $formdata['aircargo'];
	$contact_domestiquede = $formdata['domestique'];
	$contact_maritimede = $formdata['maritime'];
	$contact_a = $formdata['a'];
	$contact_sku = $formdata['hidden'];
	...
	if ( $formtitle == 'Contact form 1' ) $listId = '47301';
	elseif ( $formtitle == 'detail product' ) $listId = '47298';
	elseif ( $formtitle == 'Les affaires du moment!' ) $listId = '47300';
	elseif ( $formtitle == 'Air Cargo' ) $listId = '47296';
	elseif ( $formtitle == 'Transport Domestique' ) $listId = '47294';
	elseif ( $formtitle == 'Transport Maritime' ) $listId = '47295';
        elseif ( $formtitle == 'newsletter_home' ) $listId = '58169';
        elseif ( $formtitle == 'home_form' ) $listId = '58170';

	//this is the base api post http url
	$post_url = 'https://app.icontact.com/icp/a/1037458/c/9653/';

	$headers = array(
			'Accept' => 'application/json',
			'Content-Type' => 'application/json',
			'Api-Version' => '2.0',
			'Api-AppId' => '5PzjmGvRsjZiSs9ca4aOs0adVE8Txels', // app id here
			'Api-Username' => 'Sylccorp', // this is the log in username
			'Api-Password' => 'sylcnew!@#', // this is the password for api app
			'user-agent' => 'Contact Form 7 Integration' // this can be whatever you want
	);

	if ( $formtitle == 'Contact form 1' || $formtitle == 'Transport Domestique' || $formtitle == 'Air Cargo' || $formtitle == 'Transport Maritime') {
		$contact_data = json_encode(array(array(
				'email' => $contact_email,
				'firstName' => $contact_fname,
				'phone' => $contact_phone,
				'notes' => $contact_notes,
    			'aircargode' => $contact_aircargode,
				'domestiquede' => $contact_domestiquede,
				'maritimede' => $contact_maritimede,
				'a' => $contact_a
		))); } else if($formtitle == 'Les affaires du moment!' || $formtitle == 'home_form'){
			$contact_data = json_encode(array(array(
					'email' => $contact_email,
					'firstName' => $contact_fname,
					'phone' => $contact_phone,
					'notes' => $contact_comment
			))); } else if($formtitle == 'detail product'){
				$contact_data = json_encode(array(array(
						'email' => $contact_email,
			...
			} else if($formtitle == 'newsletter_home'){
			$contact_data = json_encode(array(array(
					'email' => $contact_email
			)));
			}
