    ...
    <div class="gallery_box">
      <ul>
        ...
        <li>
          ...
          <div class="gallery_box_ccntent">Sylc-Export vous offres des packs adaptes a votre budget, demandez nous...</div>
        </li>
        <li>
          ...
          <div class="gallery_box_ccntent">Tous les avantages, competences et prix direct USA avec votre partenaire Sylc-Export. </div>
        </li>
      </ul>
    </div>
