          ...
          <div class="select_sub show">
              <ul class="sub">
                ...
                <li <?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false && strpos($_SERVER['REQUEST_URI'],'car') !==false  && basename($_SERVER['REQUEST_URI'])=='index.php'){?>class="sub_show"<?php } ?>><a href="<?=DEFAULT_ADMIN_URL?>/contact/car/index.php">Cars Enquiry</a></li>
                 ...
                 <li <?php  if(strpos($_SERVER['REQUEST_URI'],'users')!==false && basename($_SERVER['REQUEST_URI'])=='index.php'){?>class="sub_show"<?php } ?>><a href="<?php echo DEFAULT_ADMIN_URL?>/users/index.php">User Leads</a></li>
                 ...
                 <li <?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false && strpos($_SERVER['REQUEST_URI'],'phone') !==false){?>class="sub_show"<?php } ?>><a href="<?php echo DEFAULT_ADMIN_URL?>/contact/phone/index.php">Phone Leads</a></li>
                 <li <?php  if(strpos($_SERVER['REQUEST_URI'],'contact')!==false && strpos($_SERVER['REQUEST_URI'],'newsletter') !==false){?>class="sub_show"<?php } ?>><a href="<?php echo DEFAULT_ADMIN_URL?>/contact/newsletter/index.php">Newsletter Subscribers
              </ul>
            </div>
            <!--[if IE 7]><!--></a><!--<![endif]-->
            <!--[if lte IE 6]><table><tr><td><![endif]-->
