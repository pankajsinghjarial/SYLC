...
if($installed==true){
 ...
 $server = 'localhost';
 $database = 'sylcexpo_sylc_new';
 $datausername = 'sylcexpo_corpo';
 $password = 'sylc!@#'; 
 ...
 $application_root = '/home1/sylcexpo/public_html/livehelp/';
 ...
 $API_HOME_DIR = '/home1/sylcexpo/public_html/livehelp/' . 'txt-db-api/';
