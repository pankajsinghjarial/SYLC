...
class Mage_Catalog_Model_Product_Attribute_Backend_Media extends Mage_Eav_Model_Entity_Attribute_Backend_Abstract
{
        ...
        $mediaAttribute = null, $move = false, $exclude = true)
    {
        ...
        $fileName       = strtolower(Mage_Core_Model_File_Uploader::getCorrectFileName($pathinfo['basename']));
        $dispretionPath = strtolower(Mage_Core_Model_File_Uploader::getDispretionPath($fileName));
