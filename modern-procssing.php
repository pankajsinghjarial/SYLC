...
if(isset($submit) && $submit==''){ 
	$content = '<table width="75%" border="0" cellpadding="2" cellspacing="0">
			...
			$tomail = "yoann.attia@sylc-export.com";
			...
			if(mail($tomail, $subject, $content, $headers) ){
...
$data.= "<notes>$comments</notes>\r\n";

$data.= "<anneede>$from</anneede>\r\n";

$data.= "<societe>$company</societe>\r\n";
...
mail($to,$subject,$message,$headers);
					...
					window.location.href = "http://www.sylc-export.com/voiture-americaine-occasion-ancienne/moderne-occasion?respons=thanks3";
					</script>
					';
