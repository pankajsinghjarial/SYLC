...
<div class="stock_outer">
  ...
  <?php 
        ...
        <?php while ( have_posts() ) : the_post();  ?>
         <div class="stock_indent">
         	<img class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>"  title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_thumbnail(); ?>"/>            
            	...
            	<p><?php the_title(); ?><span><a href="<?php echo esc_url( wpsc_the_product_permalink() ); ?>">Détails</a><img src="<?php echo get_bloginfo('template_url')?>/images/arrow.png" width="6" height="7" alt=""></span></p>
        ...
        <div class="stock_indent">
          ...
          <p>Ford F-150<span><a href="#">View Details</a><img src="<?php echo get_bloginfo('template_url')?>/images/arrow.png" width="6" height="7" alt=""></span></p>
          </div><?php */?>
