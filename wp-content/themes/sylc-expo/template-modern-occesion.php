  ...
  <div class="inner_banner1">
    <div class="wrapper">
	 ...
	 <?php endwhile;?>
           ...
           <?php  } ?>
          <FORM NAME="listmenu0" action="http://www.sylc-export.com/modern-procssing.php" enctype="multipart/form-data" method="post" onSubmit="return checkValidation();"> 
