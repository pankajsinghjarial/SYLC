	  ...
	  if($version == $CSLH_Config['version']){
       ...
       $UNTRUSTED['action'] = "INSTALL";
        ...
        if($CSLH_Config['version'] == "2.2"){ $installationtype = "upgrade22"; }
         ...
         // higher versions:    
         if($CSLH_Config['version'] == "3.3.7"){ $installationtype = "upgrade336"; }                                      
         if($CSLH_Config['version'] == "3.3.8"){ $installationtype = "upgrade336"; }        
         if($CSLH_Config['version'] == "3.3.9"){ $installationtype = "upgrade336"; }        
         if($CSLH_Config['version'] == "4.0.0"){ $installationtype = "upgrade336"; }   
         if($CSLH_Config['version'] == "4.0.1"){ $installationtype = "upgrade336"; }   
